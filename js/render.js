...
const renderWebGL = (glData, rotation) => {
    ...
    if (!worldUnifLoc) {
        throw new Error('World uniform location is null');
    }
    if (!viewUnifLoc) {
        throw new Error('View uniform location is null');
    }
    if (!invTransUnifLoc) {
        throw new Error('Inverse transpose uniform location is null');
    }
    if (!lightDirUnifLoc) {
        throw new Error('Light direction uniform location is null');
    }
    if (!spotLightDirUnifLoc) {
        throw new Error('Spot light direction uniform location is null');
    }
    if (!pointLightPosUnifLoc) {
        throw new Error('Light position uniform location is null');
    }
    if (!spotLightPosUnifLoc) {
        throw new Error('Spot light position uniform location is null');
    }

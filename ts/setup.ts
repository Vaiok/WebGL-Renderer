...
interface WebGLData {
    ...
    spotLightDirUnifLoc: WebGLUniformLocation | null,
    pointLightPosUnifLoc: WebGLUniformLocation | null,
    spotLightPosUnifLoc: WebGLUniformLocation | null,
    ambLightColorUnifLoc: WebGLUniformLocation | null,
